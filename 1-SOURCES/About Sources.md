...
This README is the **authoritative document** for everything in `1-SOURCES/`: what goes here, how to format it, how to link it, and the checklist for adding a new file. The LLM-facing operational summary lives in the root [`CLAUDE.md`](../CLAUDE.md).
...
- [`../CLAUDE.md`](../CLAUDE.md) — the operational guide for the whole vault.
