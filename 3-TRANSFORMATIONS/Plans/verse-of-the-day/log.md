...
- **Themes — no back-to-back repeats only.** Day 30's theme was **self-responsibility**, so Day 31 just needs a *different* theme; everything earlier is open to reuse (see `selection-criteria.md` §3). Recent run (Days 26–30): wise-priorities, taming-the-mind, small-good-deeds, freedom-from-craving, self-responsibility. Still-uncovered themes worth surfacing: gratitude, sympathetic joy (muditā), restraint of the senses, compassion (karuṇā).
