...
- **Source imports queued (per Evan):** import **T210 Chinese Dharmapada** and **Tibetan Udānavarga (Toh 326)** — both short Buddha-spoken verse collections — to supply compliant Chinese and Tibetan picks (fixes Day 19 and future non-Pali slots, and restores canon balance). Requires the source texts / ingestion via `json-to-source-text`.
