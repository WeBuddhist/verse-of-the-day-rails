...
- **Themes — no back-to-back repeats only.** Day 27's theme was **taming-the-mind**, so Day 28 just needs a *different* theme from that one; everything earlier is open to reuse (themes may recur after a gap — see `selection-criteria.md` §3). Recent run for reference (Days 23–27): harmlessness, inner-peace, self-knowledge, wise-priorities, taming-the-mind. Still-uncovered themes worth surfacing: gratitude, sympathetic joy (muditā), restraint of the senses, compassion (karuṇā) — plus any theme is reusable after a gap.
