...
| 14 | Kangyur sūtra section, all 84000-published (Toh 8–359) | Tibetan + En | `bo-toh<N>.md` + `en-toh<N>-84000.md` | **imported** — 234 texts: PD Degé Tibetan (OpenPecha) paired with 84000's verbatim English reference (CC BY-NC-ND). Covers Prajñāpāramitā, Avataṃsaka, Ratnakūṭa, General Sūtra; **no tantra/Vinaya**. Includes the giant Perfection of Wisdom texts (large). Pairing is file-level by Toh; block-level folio alignment (imgnum↔folio) is a refinement. |
